...
print(colored('SAEED NOROUZI\n', 'blue'))
print(colored('HAMID AKHAVAN\n', 'blue'))
...
def check_server_status(server_ip, port):
    try:
        ...
        if result == 0:
            print(colored('The server is online.\n', 'green'))
            return "The server is online."
        else:
            print(colored('The server is offline.\n', 'red'))
...
def menu():
      ...
      if choise=="G":
          ...
          print(colored('Please choose through the options(G,P,PORTS,C)','red',attrs=['bold']))
